                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-100/50 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                                    ...
                                    <p className="text-gray-500 text-sm">ttssolutions.tech@gmail.com</p>
                                ...
                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-100/50 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                                    ...
                                    <p className="text-gray-500 text-sm">+91 9565314883</p>
                                    <p className="text-gray-500 text-sm">+91 6391538103</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#1E2F6E] p-8 rounded-3xl shadow-xl flex items-start gap-6 text-white relative overflow-hidden group">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/70 leading-relaxed">
                                        1st Floor, Triunity Tech solutions,<br />
                                        C-4023, Sector-10, Rajajipuram, Lucknow<br />
                                    ...
                                    {[
                                        {
                                            ...
                                            link: "https://www.linkedin.com/company/triunity-tech-solution/",
                                        },
                                        {
                                            icon: FaInstagram,
                                            color: "hover:bg-green-600",
                                            link: "https://www.instagram.com/triunitytechsolutions?igsh=dHNxc2RkOGU5M3lm",
                                        },
                                    ].map((social, i) => (
                                        <a
                                            key={i}
                                            href={social.link}   // ✅ dynamic link
                                            target="_blank"
